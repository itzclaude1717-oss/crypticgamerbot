...
def run_scheduler():
    ...
    print(f"[{datetime.now().strftime('%Y-%m-%d %H:%M')}] XRPL Daily Bot starting...")
    print("=" * 60)
    ...
    print("\nSchedule active:")
    print("  Content: 7am 9am 11am 1pm 3pm 5pm 8pm 10pm")
    print("  Engage top XRP tweets: every 45 min")
    print("  Engage influencers:    every 2 hrs")
    print("  Like XRP content:      every 1 hr")
    print("  Reply to mentions:     every 30 min")
    print("  Follow-back:           every 1 hr")
    print("  Strategic follows:     every 3 hrs")
    print("=" * 60)
